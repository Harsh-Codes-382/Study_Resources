...
export const HLD_TIERS = [
  {
    ...
    topics: [
      { name: "URL Shortener (TinyURL)", status: "done", note: "01-url-shortener-tinyurl" },
      { name: "Online Bookstore (Amazon)" },
      { name: "Text Storage (Pastebin)" },
      { name: "Authentication System" },
      { name: "Content Delivery Network (CDN)" },
      { name: "Distributed Cache", status: "done", note: "02-distributed-cache" },
      { name: "Distributed Job Scheduler", status: "done", note: "03-distributed-job-scheduler" },
  ...
  },
  {
    ...
    topics: [
      ...
      { name: "TikTok" },
      { name: "YouTube" },
      { name: "Netflix", status: "done", note: "06-ott-platform-netflix" },
      { name: "Spotify" },
      { name: "Shopify" },
      ...
      { name: "Top-K Leaderboard", status: "done", note: "12-top-k-leaderboard" },
  ...
  },
  {
    ...
    topics: [
      ...
      { name: "Ticket Booking (BookMyShow)", status: "done", note: "05-ticket-booking-bookmyshow" },
